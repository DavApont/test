...
?>
<?php if ($view1->nombre_departamento->Visible) { // nombre_departamento ?>
	<?php if ($view1->SortUrl($view1->nombre_departamento) == "") { ?>
		<td><div id="elh_view1_nombre_departamento" class="view1_nombre_departamento"><div class="ewTableHeaderCaption"><?php echo $view1->nombre_departamento->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->nombre_departamento) ?>',1);"><div id="elh_view1_nombre_departamento" class="view1_nombre_departamento">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->nombre_departamento->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->nombre_departamento->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->nombre_departamento->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($view1->nombre_producto->Visible) { // nombre_producto ?>
	<?php if ($view1->SortUrl($view1->nombre_producto) == "") { ?>
		<td><div id="elh_view1_nombre_producto" class="view1_nombre_producto"><div class="ewTableHeaderCaption"><?php echo $view1->nombre_producto->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->nombre_producto) ?>',1);"><div id="elh_view1_nombre_producto" class="view1_nombre_producto">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->nombre_producto->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->nombre_producto->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->nombre_producto->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($view1->cantidad_existencia->Visible) { // cantidad_existencia ?>
	<?php if ($view1->SortUrl($view1->cantidad_existencia) == "") { ?>
		<td><div id="elh_view1_cantidad_existencia" class="view1_cantidad_existencia"><div class="ewTableHeaderCaption"><?php echo $view1->cantidad_existencia->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->cantidad_existencia) ?>',1);"><div id="elh_view1_cantidad_existencia" class="view1_cantidad_existencia">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->cantidad_existencia->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->cantidad_existencia->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->cantidad_existencia->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($view1->status_producto->Visible) { // status_producto ?>
	<?php if ($view1->SortUrl($view1->status_producto) == "") { ?>
		<td><div id="elh_view1_status_producto" class="view1_status_producto"><div class="ewTableHeaderCaption"><?php echo $view1->status_producto->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->status_producto) ?>',1);"><div id="elh_view1_status_producto" class="view1_status_producto">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->status_producto->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->status_producto->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->status_producto->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($view1->nombre_departamento->Visible) { // nombre_departamento ?>
		<td<?php echo $view1->nombre_departamento->CellAttributes() ?>>
<span<?php echo $view1->nombre_departamento->ViewAttributes() ?>>
<?php echo $view1->nombre_departamento->ListViewValue() ?></span>
<a id="<?php echo $view1_list->PageObjName . "_row_" . $view1_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($view1->nombre_producto->Visible) { // nombre_producto ?>
		<td<?php echo $view1->nombre_producto->CellAttributes() ?>>
<span<?php echo $view1->nombre_producto->ViewAttributes() ?>>
<?php echo $view1->nombre_producto->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($view1->cantidad_existencia->Visible) { // cantidad_existencia ?>
		<td<?php echo $view1->cantidad_existencia->CellAttributes() ?>>
<span<?php echo $view1->cantidad_existencia->ViewAttributes() ?>>
<?php echo $view1->cantidad_existencia->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($view1->status_producto->Visible) { // status_producto ?>
		<td<?php echo $view1->status_producto->CellAttributes() ?>>
<span<?php echo $view1->status_producto->ViewAttributes() ?>>
<?php echo $view1->status_producto->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
