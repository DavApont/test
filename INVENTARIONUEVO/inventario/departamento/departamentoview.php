...
class cdepartamento_view extends cdepartamento {
	...
	function __construct() {
		...
		if (@$_GET["codigo_departamento"] <> "") {
			$this->RecKey["codigo_departamento"] = $_GET["codigo_departamento"];
			$KeyUrl .= "&amp;codigo_departamento=" . urlencode($this->RecKey["codigo_departamento"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["codigo_departamento"] <> "") {
				...
				$this->RecKey["codigo_departamento"] = $this->codigo_departamento->QueryStringValue;
			} else {
...
<?php if (!$departamento_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fdepartamentoview" id="fdepartamentoview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="departamento">
<table class="ewGrid"><tr><td>
<table id="tbl_departamentoview" class="table table-bordered table-striped">
...
<?php echo $departamento->codigo_departamento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($departamento->nombre_departamento->Visible) { // nombre_departamento ?>
	<tr id="r_nombre_departamento">
		<td><span id="elh_departamento_nombre_departamento"><?php echo $departamento->nombre_departamento->FldCaption() ?></span></td>
...
<?php echo $departamento->nombre_departamento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($departamento->status_departamento->Visible) { // status_departamento ?>
	<tr id="r_status_departamento">
		<td><span id="elh_departamento_status_departamento"><?php echo $departamento->status_departamento->FldCaption() ?></span></td>
...
<?php echo $departamento->status_departamento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
