...
class cusuarios_list extends cusuarios {
	...
	// Project ID
	var $ProjectID = "{96318F98-727F-45AD-A645-8B951B001133}";
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->contrasena, $Keyword);
		return $sWhere;
	}
...
<div class="accordion ewDisplayTable ewSearchTable" id="fusuarioslistsrch_SearchGroup">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($usuarios_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
...
<form name="fusuarioslist" id="fusuarioslist" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="usuarios">
...
<?php if ($usuarios->usuario->Visible) { // usuario ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->contrasena->Visible) { // contrasena ?>
	<?php if ($usuarios->SortUrl($usuarios->contrasena) == "") { ?>
		<td><div id="elh_usuarios_contrasena" class="usuarios_contrasena"><div class="ewTableHeaderCaption"><?php echo $usuarios->contrasena->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->contrasena) ?>',1);"><div id="elh_usuarios_contrasena" class="usuarios_contrasena">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->contrasena->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->contrasena->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->contrasena->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $usuarios->usuario->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->contrasena->Visible) { // contrasena ?>
		<td<?php echo $usuarios->contrasena->CellAttributes() ?>>
<span<?php echo $usuarios->contrasena->ViewAttributes() ?>>
<?php echo $usuarios->contrasena->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
