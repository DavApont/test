...
?>
<form name="fusuariosdelete" id="fusuariosdelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($usuarios->contrasena->Visible) { // contrasena ?>
		<td><span id="elh_usuarios_contrasena" class="usuarios_contrasena"><?php echo $usuarios->contrasena->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_contrasena" class="control-group usuarios_contrasena">
