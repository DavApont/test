...
class cview1 extends cTable {
	...
	function __construct() {
		...
		// nombre_departamento
		$this->nombre_departamento = new cField('view1', 'view1', 'x_nombre_departamento', 'nombre_departamento', '`nombre_departamento`', '`nombre_departamento`', 200, -1, FALSE, '`nombre_departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nombre_departamento'] = &$this->nombre_departamento;

		// nombre_producto
		$this->nombre_producto = new cField('view1', 'view1', 'x_nombre_producto', 'nombre_producto', '`nombre_producto`', '`nombre_producto`', 200, -1, FALSE, '`nombre_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nombre_producto'] = &$this->nombre_producto;

		// cantidad_existencia
		$this->cantidad_existencia = new cField('view1', 'view1', 'x_cantidad_existencia', 'cantidad_existencia', '`cantidad_existencia`', '`cantidad_existencia`', 200, -1, FALSE, '`cantidad_existencia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cantidad_existencia'] = &$this->cantidad_existencia;

		// status_producto
		$this->status_producto = new cField('view1', 'view1', 'x_status_producto', 'status_producto', '`status_producto`', '`status_producto`', 200, -1, FALSE, '`status_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
