...
?>
<form name="fusuariosview" id="fusuariosview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($usuarios->contrasena->Visible) { // contrasena ?>
	<tr id="r_contrasena">
		<td><span id="elh_usuarios_contrasena"><?php echo $usuarios->contrasena->FldCaption() ?></span></td>
...
<?php echo $usuarios->contrasena->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
