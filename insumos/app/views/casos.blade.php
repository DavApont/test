...
@section('content')
    ...
    {{ Form::open(array('url' => 'casos/guardar/','id' => 'casos' , 'role' => 'form', 'class' => 'form-horizontal' )) }}
    	<div class="form-group">
			{{ Form::label('cama', 'Cama: ', array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{ Form::text('cama', '',array('id' => 'cama','class' => 'form-control'))}}
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{ Form::text('habitacion', '',array('id' => 'habitacion', 'class' => 'form-control'))}} 				
			</div>

		</div>
		
		<div class="form-group">
			{{ Form::label('fecha-ingreso', 'Fecha de Ingreso: ', array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{ Form::text('fecha-ingreso', '',array('id' => 'fecha-ingreso', 'class' => 'form-control'))}} 
			</div>
						
		</div>

		<div class="form-group">
			{{ Form::label('servicios','Servicios:', array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{ Form::select('servicios',$servicios, '', array('id' => 'servicios', 'class' => 'form-control'))}} 
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{ Form::text('diagnostico', '',array('id' => 'diagnostico', 'class' => 'form-control'))}} 	
			</div>
				
		</div>

		<div class="form-group">
			{{ Form::label('medico', 'Medico del Caso: ', array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{ Form::text('medico', '',array('id' => 'medico', 'class' => 'form-control'))}}
			</div>
						
		</div>

		<div class="form-group">
			{{ Form::label('fecha-egreso', 'Fecha de Egreso: ', array('class' => 'col-sm-2 control-label'))}}

			<div class="col-sm-4">
				{{ Form::text('fecha-egreso', '',array('id' => 'fecha-egreso', 'class' => 'form-control'))}} 	
			</div>
						
		</div>
		<div class="form-group">
			{{ Form::submit("Guardar Caso", array('class' => 'btn btn-primary'))}}			
		</div>
	...
	<div class="tab-content">
		<div class="tab-pane active" id="medicina-suministrada">  
			{{ Form::open(array('id' => 'casos-medicinas','class' => 'form-horizontal'))}}
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{ Form::select('medicamento', 
							array(
								'medicamento1'=> 'Medicamento 1',
								'medicamento2'=> 'Medicamento 2',
								'medicamento3'=> 'Medicamento 3'
							), '',
							array(
								'id' => 'medicamento',
								'class' => 'form-control'
		...
		<div class="tab-pane" id="medico-quirurgico">
			{{ Form::open(array('id' => 'casos-material-medico','class' => 'form-horizontal'))}}
				<div class="form-group">
					{{ Form::label('tipo-material-medico', 'Tipo de Material Médico:', array('class' => 'col-sm-2 control-label'))}}

					<div class="col-sm-4">
						{{ Form::select('tipo-material-medico', 
								array(
									'tipomaterial1'=> 'Tipo de Material 1',
									'tipomaterial2'=> 'Tipo de Material 2',
									'tipomaterial3'=> 'Tipo de Material 3'
								), '',
								array(
