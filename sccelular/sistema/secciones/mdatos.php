...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$Result1 = mysql_query("UPDATE cliente SET SUB='$_POST[stotal]',IVA='$_POST[iva]',TOTAL1='$_POST[total]',DESCRIPCIO='$_POST[descripcion]',STATUS1='$_POST[trabajo]' where FACTURA ='$fact' ", $conexion) or die(mysql_error());


?>
<center><p class="titulocajitas" >Los Datos han sido Modificados con exito.</p>
<input type="button" value="IMPRIMIR" class="titulocajitas" onclick="javascript:window.open('secciones/printf.php?fact=<?php echo $fact; ?>', 'noimporta', 'width=780, height=465, scrollbars=NO')"></center>
<?php
...
?>    </td>
  ...
  <tr>
    ...
    <td colspan="2" class="titulocajitas">
    <textarea name="descripcion" cols="70" rows="3" class="negrita" id="descripcion"><?Php echo "$scc[18]"; ?></textarea>    </td>
  </tr>
  <tr>
...
?>      
          ...
          <td width="29%" class="titulocajitas">
            <label>
            <input type="text" name="stotal" id="stotal" value="<?Php echo "$scc[22]"; ?>" onBlur="caliva()" class="negrita"/>
          </label>          </td>
...
<center>
  <label>
    ...
    <input type="submit" name="enviar" id="enviar" class="negrita" value="::    Guardar    ::">
  </label>
</center>
