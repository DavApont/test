...
@section('content')
    ...
    {{ Form::model($caso,array('url' => "pacientes/$paciente->id/casos/$caso->id",'method' => 'put','class' => 'form-horizontal'))}}
	...
	<div class="tab-content">
		<div class="tab-pane active" id="medicina-suministrada">  
			{{ Form::open(array('url' => "pacientes/$paciente->id/casos/$caso->id/medicamentos",'id' => 'casos-medicinas','class' => 'form-horizontal','style' =>'display:none'))}}
				<div class="form-group">
		...
		<div class="tab-pane" id="medico-quirurgico">
			{{ Form::open(array('url' => "pacientes/$paciente->id/casos/$caso->id/materialmedico",'id' => 'casos-material-medico','class' => 'form-horizontal','style' =>'display:none'))}}
				<div class="form-group">
