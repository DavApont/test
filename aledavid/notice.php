...
$idelforo = "10";     // la id del foro donde entraras tus noticias
...
$url_style = "notice.htm";     // url del archivo que contiene la tabla
...
$style = eregi_replace("{textnews}", substr($texto_news,0,300).' ...', $style);
