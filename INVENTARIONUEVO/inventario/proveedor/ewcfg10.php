...
define("EW_ROOT_RELATIVE_PATH", "..\..\..\Users\NELLYMAR\Documents\PHPMaker\Projects\project1", TRUE); // Relative path of app root
...
define("EW_PROJECT_ID", "{1C6EAAA4-783D-4754-BFD0-A4DD922C271D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'W2OSE0H6y1KevtIR', TRUE); // Random key for encryption
...
define("EW_CONN_DB", 'bdinventario', TRUE);

// ADODB (Access/SQL Server)
define("EW_CODEPAGE", 28596, TRUE); // Code page
