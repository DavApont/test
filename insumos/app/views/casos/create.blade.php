...
@section('content')
    ...
    {{ Form::open(array('url' => "pacientes/$paciente/casos",'id' => 'casos' , 'role' => 'form', 'class' => 'form-horizontal' )) }}
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{ Form::text('fecha_ingreso', '',array('id' => 'fecha_ingreso', 'class' => 'form-control'))}} 
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{ Form::text('medico_caso', '',array('id' => 'medico_caso', 'class' => 'form-control'))}}
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{ Form::text('fecha_egreso', '',array('id' => 'fecha_egreso', 'class' => 'form-control'))}} 	
			</div>
