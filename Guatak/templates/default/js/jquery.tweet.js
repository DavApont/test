(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["torosuelto"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
