...
FROM cliente Where FACTURA='$factura' limit 0,1", $conexion);
...
?> </div>
<div class="clausula" >La empresa no se hace responsable de los equipos que no sean retirados en un lapso de 90 dias a partir de la fecha de ingreso : Acepto Clausula</div>
