...
$query_impnoticias = "SELECT *,DATE_FORMAT(fechapub,'%d') as dia,DATE_FORMAT(fechapub,'%m') as mes,DATE_FORMAT(fechapub,'%y') as ano FROM noticias where idnoticia=$idnoticia";
...
<form name="form1" method="post" action="">
    ...
    <input type="submit" value="Enviar Comentario" name="envcomentario" />
  <input type="hidden" name="ajax" id="ajax" value="no">
</form>
